use octocrab::{Octocrab, params::repos::Reference, models::repos::Object};
...
async fn main() -> octocrab::Result<()> {
    ...
    let refs = octocrab.repos("ekuinox", "goshuin").get_ref(&Reference::Branch("deploy".into())).await?;
    ...
    let refs = octocrab.repos("ekuinox", "goshuin").create_ref(
        &Reference::Branch("deploy-1".into()), sha).await;
